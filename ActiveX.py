...
class ActiveX(object):
    def __init__(self):
    	...
    	self.clsid['008B6010-1F3D-11D1-B0C8-00A0C9055D74'] = MSVFP()
...
class DivX(ActiveX):
    def __init__(self):
        ...
        self.classname = 'DivX'
        self.cve_id = ('CVE-NOMATCH', )
        self.dcription = 'DivX Player 6.6.0 ActiveX Control'
...
class RisingScanner(ActiveX):
    def __init__(self):
        self.js_src = self.load_js_src('RisingScanner.js')
...
class ICQToolbar(ActiveX):
    def __init__(self):
	self.js_src = self.load_js_src('ICQToolbar.js')
