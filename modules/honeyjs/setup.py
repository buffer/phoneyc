#
# The HoneyJS Package for PHoneyC v 0.0.1
#
# JS engine for python with extra security auditing features. derived from
# python-spidermonkey:Python/JavaScript bridge module, making use of Mozilla's
# spidermonkey JavaScript implementation. This file is originally written by
# Paul J. Davis Z. Chen has modified it to make the honeyjs package
# 
# Here is the original file header:
#
...
JS engine for python with extra security auditing features. derived from
python-spidermonkey:Python/JavaScript bridge module, making use of Mozilla's
spidermonkey JavaScript implementation.
...
setup(
    ...
    version = "0.0.1",
    license = "MIT",
    author = "Z. Chen, Paul J. Davis",
    author_email = "czj.pub@gmail.com",
    description = "An auditted JS engine.",
